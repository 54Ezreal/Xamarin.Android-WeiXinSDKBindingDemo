...
namespace Com.Tencent.MM.Opensdk.Modelmsg {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']"
	[global::Android.Runtime.Register ("com/tencent/mm/opensdk/modelmsg/WXDesignerSharedObject", DoNotGenerateAcw=true)]
	public partial class WXDesignerSharedObject : global::Java.Lang.Object, global::Com.Tencent.MM.Opensdk.Modelmsg.WXMediaMessage.IMediaObject {


		static IntPtr designerName_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/field[@name='designerName']"
		[Register ("designerName")]
		public string DesignerName {
			get {
				if (designerName_jfieldId == IntPtr.Zero)
					designerName_jfieldId = JNIEnv.GetFieldID (class_ref, "designerName", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, designerName_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, designerName_jfieldId, native_value);
				} finally {
		...
		static IntPtr designerRediretctUrl_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/field[@name='designerRediretctUrl']"
		[Register ("designerRediretctUrl")]
		public string DesignerRediretctUrl {
			get {
				if (designerRediretctUrl_jfieldId == IntPtr.Zero)
					designerRediretctUrl_jfieldId = JNIEnv.GetFieldID (class_ref, "designerRediretctUrl", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, designerRediretctUrl_jfieldId);
				return JNIEnv.GetString (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (designerRediretctUrl_jfieldId == IntPtr.Zero)
				...
				IntPtr native_value = JNIEnv.NewString (value);
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, designerRediretctUrl_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		static IntPtr designerUIN_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/field[@name='designerUIN']"
		[Register ("designerUIN")]
		public int DesignerUIN {
			get {
				if (designerUIN_jfieldId == IntPtr.Zero)
					designerUIN_jfieldId = JNIEnv.GetFieldID (class_ref, "designerUIN", "I");
				return JNIEnv.GetIntField (((global::Java.Lang.Object) this).Handle, designerUIN_jfieldId);
			}
			set {
				if (designerUIN_jfieldId == IntPtr.Zero)
					designerUIN_jfieldId = JNIEnv.GetFieldID (class_ref, "designerUIN", "I");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, designerUIN_jfieldId, value);
				} finally {
				}
			}
		}
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/field[@name='thumburl']"
		[Register ("thumburl")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/field[@name='url']"
		[Register ("url")]
		public string Url {
			get {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/mm/opensdk/modelmsg/WXDesignerSharedObject", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WXDesignerSharedObject); }
		}

		protected WXDesignerSharedObject (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/constructor[@name='WXDesignerSharedObject' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WXDesignerSharedObject ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (WXDesignerSharedObject)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/constructor[@name='WXDesignerSharedObject' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe WXDesignerSharedObject (string p0, int p1, string p2, string p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.MM.Opensdk.Modelmsg.WXDesignerSharedObject __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Opensdk.Modelmsg.WXDesignerSharedObject> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckArgs ();
		}
#pragma warning restore 0169

		static IntPtr id_checkArgs;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/method[@name='checkArgs' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/method[@name='serialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/method[@name='type' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXDesignerSharedObject']/method[@name='unserialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
