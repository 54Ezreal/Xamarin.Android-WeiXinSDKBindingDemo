...
namespace Com.Tencent.MM.Opensdk.Modelmsg {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']"
	[global::Android.Runtime.Register ("com/tencent/mm/opensdk/modelmsg/WXLocationObject", DoNotGenerateAcw=true)]
	public partial class WXLocationObject : global::Java.Lang.Object, global::Com.Tencent.MM.Opensdk.Modelmsg.WXMediaMessage.IMediaObject {


		static IntPtr lat_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/field[@name='lat']"
		[Register ("lat")]
		public double Lat {
			get {
		...
		static IntPtr lng_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/field[@name='lng']"
		[Register ("lng")]
		public double Lng {
			get {
				if (lng_jfieldId == IntPtr.Zero)
					lng_jfieldId = JNIEnv.GetFieldID (class_ref, "lng", "D");
				return JNIEnv.GetDoubleField (((global::Java.Lang.Object) this).Handle, lng_jfieldId);
			}
			set {
				if (lng_jfieldId == IntPtr.Zero)
					lng_jfieldId = JNIEnv.GetFieldID (class_ref, "lng", "D");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, lng_jfieldId, value);
				} finally {
				}
			}
		}
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/mm/opensdk/modelmsg/WXLocationObject", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WXLocationObject); }
		}

		protected WXLocationObject (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/constructor[@name='WXLocationObject' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WXLocationObject ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (WXLocationObject)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/constructor[@name='WXLocationObject' and count(parameter)=2 and parameter[1][@type='double'] and parameter[2][@type='double']]"
		[Register (".ctor", "(DD)V", "")]
		public unsafe WXLocationObject (double p0, double p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.MM.Opensdk.Modelmsg.WXLocationObject __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Opensdk.Modelmsg.WXLocationObject> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckArgs ();
		}
#pragma warning restore 0169

		static IntPtr id_checkArgs;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/method[@name='checkArgs' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/method[@name='serialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/method[@name='type' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXLocationObject']/method[@name='unserialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
