...
namespace Com.Tencent.MM.Opensdk.Modelmsg {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']"
	[global::Android.Runtime.Register ("com/tencent/mm/opensdk/modelmsg/WXWebpageObject", DoNotGenerateAcw=true)]
	public partial class WXWebpageObject : global::Java.Lang.Object, global::Com.Tencent.MM.Opensdk.Modelmsg.WXMediaMessage.IMediaObject {


		static IntPtr canvasPageXml_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/field[@name='canvasPageXml']"
		[Register ("canvasPageXml")]
		public string CanvasPageXml {
			get {
				if (canvasPageXml_jfieldId == IntPtr.Zero)
					canvasPageXml_jfieldId = JNIEnv.GetFieldID (class_ref, "canvasPageXml", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, canvasPageXml_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, canvasPageXml_jfieldId, native_value);
				} finally {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/field[@name='extInfo']"
		[Register ("extInfo")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/field[@name='webpageUrl']"
		[Register ("webpageUrl")]
		public string WebpageUrl {
			get {
				if (webpageUrl_jfieldId == IntPtr.Zero)
					webpageUrl_jfieldId = JNIEnv.GetFieldID (class_ref, "webpageUrl", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, webpageUrl_jfieldId);
				return JNIEnv.GetString (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (webpageUrl_jfieldId == IntPtr.Zero)
				...
				IntPtr native_value = JNIEnv.NewString (value);
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, webpageUrl_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/mm/opensdk/modelmsg/WXWebpageObject", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/constructor[@name='WXWebpageObject' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WXWebpageObject ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (WXWebpageObject)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/constructor[@name='WXWebpageObject' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe WXWebpageObject (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.MM.Opensdk.Modelmsg.WXWebpageObject __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Opensdk.Modelmsg.WXWebpageObject> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckArgs ();
		}
#pragma warning restore 0169

		static IntPtr id_checkArgs;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/method[@name='checkArgs' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/method[@name='serialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/method[@name='type' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='WXWebpageObject']/method[@name='unserialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
