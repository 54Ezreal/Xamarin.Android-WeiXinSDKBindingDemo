...
namespace Com.Tencent.MM.Opensdk.Modelmsg {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX']"
	[global::Android.Runtime.Register ("com/tencent/mm/opensdk/modelmsg/GetMessageFromWX", DoNotGenerateAcw=true)]
	public sealed partial class GetMessageFromWX : global::Java.Lang.Object {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']"
		[global::Android.Runtime.Register ("com/tencent/mm/opensdk/modelmsg/GetMessageFromWX$Req", DoNotGenerateAcw=true)]
		public partial class Req : global::Com.Tencent.MM.Opensdk.Modelbase.BaseReq {


			static IntPtr country_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/field[@name='country']"
			[Register ("country")]
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/field[@name='lang']"
			[Register ("lang")]
			public string Lang {
				get {
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/field[@name='username']"
			[Register ("username")]
			...
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/tencent/mm/opensdk/modelmsg/GetMessageFromWX$Req", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/constructor[@name='GetMessageFromWX.Req' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
			public unsafe Req ()
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/constructor[@name='GetMessageFromWX.Req' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning disable 0169
			...
			{
				global::Com.Tencent.MM.Opensdk.Modelmsg.GetMessageFromWX.Req __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Opensdk.Modelmsg.GetMessageFromWX.Req> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.Type;
			}
#pragma warning restore 0169
			...
			public override unsafe int Type {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Req']/method[@name='checkArgs' and count(parameter)=0]"
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Resp']"
		[global::Android.Runtime.Register ("com/tencent/mm/opensdk/modelmsg/GetMessageFromWX$Resp", DoNotGenerateAcw=true)]
		public partial class Resp : global::Com.Tencent.MM.Opensdk.Modelbase.BaseResp {


			static IntPtr message_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Resp']/field[@name='message']"
			[Register ("message")]
			...
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/tencent/mm/opensdk/modelmsg/GetMessageFromWX$Resp", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Resp']/constructor[@name='GetMessageFromWX.Resp' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
			public unsafe Resp ()
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
			...
			static IntPtr id_ctor_Landroid_os_Bundle_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Resp']/constructor[@name='GetMessageFromWX.Resp' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
			[Register (".ctor", "(Landroid/os/Bundle;)V", "")]
...
#pragma warning disable 0169
			...
			static int n_GetType (IntPtr jnienv, IntPtr native__this)
			{
				global::Com.Tencent.MM.Opensdk.Modelmsg.GetMessageFromWX.Resp __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Opensdk.Modelmsg.GetMessageFromWX.Resp> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.Type;
			}
#pragma warning restore 0169
			...
			static IntPtr id_getType;
			public override unsafe int Type {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Resp']/method[@name='getType' and count(parameter)=0]"
				[Register ("getType", "()I", "GetGetTypeHandler")]
				get {
					if (id_getType == IntPtr.Zero)
						id_getType = JNIEnv.GetMethodID (class_ref, "getType", "()I");
...
#pragma warning restore 0169
			...
			static IntPtr id_checkArgs;
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.opensdk.modelmsg']/class[@name='GetMessageFromWX.Resp']/method[@name='checkArgs' and count(parameter)=0]"
			[Register ("checkArgs", "()Z", "GetCheckArgsHandler")]
			public override unsafe bool CheckArgs ()
			{
				if (id_checkArgs == IntPtr.Zero)
